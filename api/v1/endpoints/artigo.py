...
@router.get('/{artigo.id}', response_model=ArtigoSchema,
...
@router.put('/{artigo.id}', response_model=ArtigoSchema,
...
@router.delete('/{artigo.id}', status_code=status.HTTP_204_NO_CONTENT)
